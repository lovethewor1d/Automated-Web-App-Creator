    ...
    questions = [
            {
                ...
                "message": "\n Using this, you can deploy and run the webapp via Docker \n"
                           "\n Please make sure Docker Desktop is running before proceeding ahead \n"
                           "\n The web application is designed using HTML, PHP, JS and CSS  \n"
                           "\n Purpose: Using this web application, you can test your pentesting skills and improve \n"
                            "\n Note: The source of the web application is present in your 'TEMP' folder, kindly delete after your testing is complete \n"
                           "\n Disclaimer: Please use this responsibly, this is a vulnerable web application containing vulnerabilitiles like SQL Injection, XSS, \n LFI, Command Execution, etc. Do not upload this on public servers! \n"
                           "\n Continue?",
                "qmark": "🤔",
                "amark": "😲",
                "name": "proceed",
...
#If else based on user choice   
    ...
    while True:
        ...
        #print(result.stdout) 
        #subprocess.run(["python", "logs.py"], capture_output=False, text=True)
        #### either - print that folder is extracted in tmp...please delete after use..
        #### or - can be used for mal analysis
