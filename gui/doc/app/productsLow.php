...
<body>
 ...
 <div align = "center">
	  ...
	  <br><br><br><br><br>
	  <!---start1-->
	  <h3><a href="productsLow.php?id=1" name="id" value="cars">Cars</a></h3>
	  <!---end1-->
	  
	  <!---start2-->
	  <h3><a href="productsLow.php?id=2" name="id" value="bikes">Bikes</a></h3>
	  <!---end2-->
	  
	  <!---start3-->
	  <h3><a href="productsLow.php?id=3" name="id" value="planes">Planes</a></h3></h3>
	  <!---end3-->
	  
	  <!---start4-->
	  <h3><a href="productsLow.php?id=4" name="id" value="laptops">Laptops</a></h3></h3>
	  <!---end4-->
	  
	  <!---start5-->
	  <h3><a href="productsLow.php?id=5" name="id" value="headphones">Headphones</a></h3></h3>
	  <!---end5-->
